...
class VSR:
    __vsr_fields = [
        ...
        ('0x0202FFFFFF', '0x020203A331', 'warning', 'textId'),
        ...
        ('0x0301FFFFFF', '0x0301010001', 'status',
         'parking_light', {'1': 'on', '2': 'off'}),
        ('0x0301FFFFFF', '0x0301020001', 'status', 'temperature_outside'),
        ('0x0301FFFFFF', '0x0301030001', 'status',
         'parking_brake', {'0': 'inactive', '1': 'active'}),
        ...
        ('0x0301FFFFFF', '0x030103000B', 'status',
         'fuel_method', {'0': 'measured', '1': 'calculated'}),
        ('0x0301FFFFFF', '0x030103000D', 'status', 'cng_level'),
        ('0x0301FFFFFF', '0x0301040001', 'doors', 'lock_left_front',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301040002', 'doors', 'open_left_front',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301040003', 'doors', 'safety_left_front',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301040004', 'doors', 'lock_left_rear',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301040005', 'doors', 'open_left_rear',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301040006', 'doors', 'safety_left_rear',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301040007', 'doors', 'lock_right_front',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301040008', 'doors', 'open_right_front',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301040009', 'doors', 'safety_right_front',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x030104000A', 'doors', 'lock_right_rear',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x030104000B', 'doors', 'open_right_rear',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x030104000C', 'doors', 'safety_right_rear',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x030104000D', 'doors', 'lock_trunk', {
         '0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x030104000E', 'doors', 'open_trunk', {
         '0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x030104000F', 'doors', 'safety_trunk',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301040010', 'doors', 'lock_hood', {
         '0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301040011', 'doors', 'open_hood', {
         '0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301040012', 'doors', 'safety_hood', {
         '0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301050001', 'windows', 'state_left_front',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301050002', 'windows', 'position_left_front'),
        ('0x0301FFFFFF', '0x0301050003', 'windows', 'state_left_rear',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301050004', 'windows', 'position_left_rear'),
        ('0x0301FFFFFF', '0x0301050005', 'windows', 'state_right_front',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301050006', 'windows', 'position_right_front'),
        ('0x0301FFFFFF', '0x0301050007', 'windows', 'state_right_rear',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301050008', 'windows', 'position_right_rear'),
        ('0x0301FFFFFF', '0x0301050009', 'windows', 'state_convertible_top',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x030105000A', 'windows', 'position_convertible_top'),
        ('0x0301FFFFFF', '0x030105000B', 'windows', 'state_roof',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x030105000C', 'windows', 'position_roof'),
        ('0x0301FFFFFF', '0x030105000D', 'windows', 'state_roof_rear',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x030105000E', 'windows', 'position_roof_rear'),
        ('0x0301FFFFFF', '0x030105000F', 'windows', 'state_service_flap',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
        ('0x0301FFFFFF', '0x0301050010', 'windows', 'position_service_flap'),
        ('0x0301FFFFFF', '0x0301050011', 'windows', 'state_spoiler',
         {'0': 'n/a', '1': 'open', '2': 'locked', '3': 'closed'}),
